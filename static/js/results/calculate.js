...
let gender = NaN;document.getElementById('sex').addEventListener('change', function (even) {
...
function calculate(age, weight, height, goal, activity, gender) {
    let res = (10*weight) + (6.25*height) - (5*age) + gender
    let callories = String(Math.floor(res*activity*goal))
