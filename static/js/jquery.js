...
!(function (e, t) {
  ...
  ;(N.tbody = N.tfoot = N.colgroup = N.caption = N.thead),
    (N.th = N.td),
    y.option ||
      (N.optgroup = N.option = [1, "<select multiple='multiple'>", '</select>'])
  var Se = /<|&#?\w+;/
  ...
  function ct(e, t, n) {
    ...
    return (
      ((!y.boxSizingReliable() && i) ||
        ...
        ((i = 'border-box' === E.css(e, 'boxSizing', !1, r)), (o = s in e)) &&
        (a = e[s]),
      (a = parseFloat(a) || 0) +
      ...
      (E.extend(E.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            ...
            ((e = e[E.expando]
              ? e
              : new E.Event(p, 'object' == _typeof(e) && e)).isTrigger = r
              ? 2
              : 3),
            (e.namespace = d.join('.')),
        ...
        if (
          ...
          try {
            ;(i.href = h.url),
              (i.href = i.href),
              (h.crossDomain =
                Bt.protocol + '//' + Bt.host != i.protocol + '//' + i.host)
          } catch (e) {
            h.crossDomain = !0
          }
        }
