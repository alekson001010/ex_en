  ...
  ;(e = 0),
    ((t = function (t, o) {
      ...
      ;(s.defaults = {
        ...
        (s.windowTimer = null),
        (t = i(t).data('slick') || {}),
        (s.options = i.extend({}, s.defaults, o, t)),
        ...
        (s.autoPlay = i.proxy(s.autoPlay, s)),
        (s.autoPlayClear = i.proxy(s.autoPlayClear, s)),
        (s.autoPlayIterator = i.proxy(s.autoPlayIterator, s)),
        (s.changeSlide = i.proxy(s.changeSlide, s)),
        (s.clickHandler = i.proxy(s.clickHandler, s)),
        (s.selectHandler = i.proxy(s.selectHandler, s)),
        (s.setPosition = i.proxy(s.setPosition, s)),
        (s.swipeHandler = i.proxy(s.swipeHandler, s)),
        (s.dragHandler = i.proxy(s.dragHandler, s)),
        (s.keyHandler = i.proxy(s.keyHandler, s)),
        (s.instanceUid = e++),
        (s.htmlExpr = /^(?:\s*(<[\w\W]+>)[^>]*)$/),
    ...
    (t.prototype.getNavTarget = function () {
      ...
      return e && null !== e ? i(e).not(this.$slider) : e
    }),
        ...
        for (o in ((s = null), r.breakpoints))
          r.breakpoints.hasOwnProperty(o) &&
            (!1 === r.originalSettings.mobileFirst
              ...
              : n > r.breakpoints[o] && (s = r.breakpoints[o]))
        null !== s
          ? (null !== r.activeBreakpoint && s === r.activeBreakpoint && !t) ||
    ...
    (t.prototype.changeSlide = function (e, t) {
      ...
      switch (
        ...
        case 'previous':
          ;(r = 0 == o ? s.options.slidesToScroll : s.options.slidesToShow - o),
            s.slideCount > s.options.slidesToShow &&
              s.slideHandler(s.currentSlide - r, !1, t)
          break
        case 'next':
          ;(r = 0 == o ? s.options.slidesToScroll : o),
            s.slideCount > s.options.slidesToShow &&
              s.slideHandler(s.currentSlide + r, !1, t)
          break
        case 'index':
      ...
      var e,
        ...
        o =
          !0 === t.options.centerMode
            ...
            : 0
      return !0 === t.options.swipeToSlide
        ? (t.$slideTrack.find('.slick-slide').each(function (s, n) {
            if (n.offsetLeft - o + i(n).outerWidth() / 2 > -1 * t.swipeLeft)
              return (e = n), !1
          }),
          Math.abs(i(e).attr('data-slick-index') - t.currentSlide) || 1)
      ...
      if (
        (!0 === n.options.centerMode
          ...
          : ((o = n.options.infinite
            ...
            !0 === n.options.fade && (0 < o && o--, s <= n.slideCount) && s++),
      ...
      for (
        ...
        if (
          ('object' == _typeof(o) || void 0 === o
            ...
            : (i = e[r].slick[o].apply(e[r].slick, s)),
          void 0 !== i)
        )
          return i
      return e
